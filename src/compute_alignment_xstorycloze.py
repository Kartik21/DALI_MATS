...
if __name__ == '__main__':
     ...
     parser.add_argument('--save_path', type=str, default='../alignment_outputs/Llama3.1/xstorycloze_formatted/')
     parser.add_argument('--embedding_path', type=str,default='/fs/nexus-scratch/kravisan/embeddings/Llama3.1/xstorycloze_formatted/')
